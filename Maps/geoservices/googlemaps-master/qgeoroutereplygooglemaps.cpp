...
QGeoRouteReplyGooglemaps::QGeoRouteReplyGooglemaps(QNetworkReply *reply, const QGeoRouteRequest &request,
                                     QObject *parent)
...
void QGeoRouteReplyGooglemaps::abort()
{
    if (!m_reply)
        return;
...
void QGeoRouteReplyGooglemaps::networkReplyFinished()
{
    if (!m_reply)
        return;
    ...
    if (document.isObject()) {
        ...
        setError(QGeoRouteReply::ParseError, QStringLiteral("Error parsing Google Maps JSON response:"));
    }
...
void QGeoRouteReplyGooglemaps::networkReplyError(QNetworkReply::NetworkError error)
{
    Q_UNUSED(error)
